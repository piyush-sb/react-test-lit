...
const ct = window,
  ...
  Kt = ct.reactiveElementPolyfillSupport,
  Ot = {
    toAttribute(e, t) {
      switch (t) {
        case Boolean:
...
class k extends HTMLElement {
  ...
  static get observedAttributes() {
    ...
    const t = [];
    return (
      this.elementProperties.forEach((n, r) => {
  ...
  static createProperty(t, n = vt) {
    if (
      ...
      const r = typeof t == "symbol" ? Symbol() : "__" + t,
        s = this.getPropertyDescriptor(t, r, n);
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const s of r) n.unshift(zt(s));
  ...
  connectedCallback() {
    ...
    this.renderRoot === void 0 && (this.renderRoot = this.createRenderRoot()),
      ...
      (t = this._$ES) === null ||
        ...
        t.forEach((n) => {
          var r;
          return (r = n.hostConnected) === null || r === void 0
            ? void 0
            : r.call(n);
        });
  }
  ...
  disconnectedCallback() {
    ...
    (t = this._$ES) === null ||
      ...
      t.forEach((n) => {
        var r;
        return (r = n.hostDisconnected) === null || r === void 0
          ? void 0
          : r.call(n);
      });
  }
      ...
      const i = s.getPropertyOptions(o),
        c =
          typeof i.converter == "function"
            ...
            : Ot;
      (this._$El = o),
        (this[o] = c.fromAttribute(n, i.type)),
        (this._$El = null);
    }
  }
  requestUpdate(t, n, r) {
    let s = !0;
    t !== void 0 &&
      (((r = r || this.constructor.getPropertyOptions(t)).hasChanged || ue)(
        this[t],
        n
      )
  ...
  update(t) {
    this._$EC !== void 0 &&
      (this._$EC.forEach((n, r) => this._$EO(r, this[r], n)),
      (this._$EC = void 0)),
      this._$Ek();
  }
  updated(t) {}
...
const ut = window,
  j = ut.trustedTypes,
  Jt = j ? j.createPolicy("lit-html", { createHTML: (e) => e }) : void 0,
  T = `lit$${(Math.random() + "").slice(9)}$`,
  he = "?" + T,
  Fe = `<${he}>`,
  H = document,
  q = (e = "") => H.createComment(e),
    ...
    for (let u = 0; u < n; u++) {
      ...
      o +=
        i === K
          ? a + Fe
          : m >= 0
          ? (r.push(d), a.slice(0, m) + "$lit$" + a.slice(m) + T + p)
          : a + T + (m === -2 ? (r.push(void 0), u) : p);
    }
  ...
  return (
    (u == null ? void 0 : u.constructor) !== a &&
      ((o = u == null ? void 0 : u._$AO) === null ||
        o === void 0 ||
        o.call(u, !1),
      a === void 0 ? (u = void 0) : ((u = new a(e)), u._$AT(e, n, r)),
      r !== void 0
        ? (((i = (c = n)._$Co) !== null && i !== void 0 ? i : (c._$Co = []))[
            r
          ] = u)
        : (n._$Cl = u)),
    u !== void 0 && (t = M(e, u._$AS(e, t.values), u, r)),
    t
  );
}
class Ke {
...
class Q {
  ...
  k(t) {
    ...
    for (const o of t)
      s === n.length
        ? n.push((r = new Q(this.O(q()), this.O(q()), this, this.options)))
        : (r = n[s]),
        r._$AI(o),
        s++;
  ...
  _$AR(t = this._$AA.nextSibling, n) {
    var r;
    for (
      (r = this._$AP) === null || r === void 0 || r.call(this, !1, !0, n);
      t && t !== this._$AB;
...
class Ve extends ft {
  ...
  j(t) {
    t && t !== b
      ? this.element.setAttribute(this.name, qe)
      : this.element.removeAttribute(this.name);
  }
}
class We extends ft {
...
const Ze = (e, t, n) => {
  var r, s;
  const o =
    (r = n == null ? void 0 : n.renderBefore) !== null && r !== void 0 ? r : t;
  let i = o._$litPart$;
  if (i === void 0) {
    const c =
      (s = n == null ? void 0 : n.renderBefore) !== null && s !== void 0
        ? s
        : null;
    o._$litPart$ = i = new Q(
      t.insertBefore(q(), c),
...
class x extends k {
  ...
  update(t) {
    ...
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
      super.update(t),
      (this._$Do = Ze(n, this.renderRoot, this.renderOptions));
  }
  connectedCallback() {
    var t;
...
(x.finalized = !0),
  ...
  (wt = globalThis.litElementHydrateSupport) === null ||
    wt === void 0 ||
    wt.call(globalThis, { LitElement: x });
...
const Y = (e) => (t) =>
  typeof t == "function"
    ? ((n, r) => (customElements.define(n, r), r))(e, t)
    : ((n, r) => {
...
const hn = (e, t, n, { allOwnKeys: r } = {}) => (
  ...
  dn = (e) => (e.charCodeAt(0) === 65279 && (e = e.slice(1)), e),
  pn = (e, t, n, r) => {
  ...
  Sn = () => {},
  xn = (e, t) => ((e = +e), Number.isFinite(e) ? e : t),
  On = (e) => {
...
function yt(e, t, n) {
  ...
  const r = n.metaTokens,
    ...
    o = n.dots,
    i = n.indexes,
    u = (n.Blob || (typeof Blob < "u" && Blob)) && Nn(t);
  ...
  function d(p, f, S) {
    ...
    if (p && !S && typeof p == "object") {
      if (l.endsWith(f, "{}"))
        ...
        (l.isArray(p) && Pn(p)) ||
        l.isFileList(p) ||
        (l.endsWith(f, "[]") && ($ = l.toArray(p)))
      )
        return (
          (f = Ae(f)),
          $.forEach(function (rt, ke) {
            !(l.isUndefined(rt) || rt === null) &&
              t.append(
  ...
  function y(p, f) {
    if (!l.isUndefined(p)) {
      ...
      h.push(p),
        l.forEach(p, function ($, L) {
          (!(l.isUndefined($) || $ === null) &&
            s.call(t, $, l.isString(L) ? L.trim() : L, f, m)) === !0 &&
            y($, f ? f.concat(L) : [L]);
        }),
        h.pop();
    }
...
function xe(e, t, n) {
  ...
  if (
    (s
      ? (o = s(t, n))
      : (o = l.isURLSearchParams(t) ? t.toString() : new Bt(t, n).toString(r)),
    o)
  ) {
    const i = e.indexOf("#");
    i !== -1 && (e = e.slice(0, i)),
...
const ne = Un,
  ...
  Ln = typeof URLSearchParams < "u" ? URLSearchParams : Bt,
  kn = FormData,
  Bn = (() => {
    let e;
...
function Re(e) {
  function t(n, r, s, o) {
    ...
    return (
      ...
      u
        ? (l.hasOwnProp(s, i) ? (s[i] = [s[i], r]) : (s[i] = r), !c)
        : ((!s[i] || !l.isObject(s[i])) && (s[i] = []),
          t(n, r, s[i], o) && l.isArray(s[i]) && (s[i] = Fn(s[i])),
          !c)
    );
  }
...
const Qn = O.isStandardBrowserEnv
  ? (function () {
      return {
...
const tr = O.isStandardBrowserEnv
  ? (function () {
...
const ir = {
  getAdapter: (e) => {
    ...
    for (
      let s = 0;
      s < t && ((n = e[s]), !(r = l.isString(n) ? at[n.toLowerCase()] : n));
      s++
    );
    if (!r)
      throw r === !1
...
function Z(e, t) {
  ...
  function s(a, d, h) {
    if (l.isUndefined(d)) {
      if (!l.isUndefined(a)) return r(void 0, a, h);
    } else return r(a, d, h);
  }
  function o(a, d) {
  ...
  function i(a, d) {
    if (l.isUndefined(d)) {
      if (!l.isUndefined(a)) return r(void 0, a);
...
function Ne(e) {
  const t = new lt(e),
    n = fe(lt.prototype.request, t);
  return (
    l.extend(n, lt.prototype, t, { allOwnKeys: !0 }),
 ...
 */
const hr = (e, t, n) => {
  for (const r of t) if (r[0] === e) return (0, r[1])();
...
var dr = Object.defineProperty,
  ...
  Ue = (e, t, n, r) => {
    for (
      var s = r > 1 ? void 0 : r ? pr(t, n) : t, o = e.length - 1, i;
      o >= 0;
      o--
    )
...
var fr = Object.defineProperty,
  ...
  Le = (e, t, n, r) => {
    for (
      var s = r > 1 ? void 0 : r ? mr(t, n) : t, o = e.length - 1, i;
      o >= 0;
      o--
    )
      (i = e[o]) && (s = (r ? i(t, n, s) : i(s)) || s);
...
var yr = Object.defineProperty,
  ...
  br = (e, t, n, r) => {
    for (
      var s = r > 1 ? void 0 : r ? gr(t, n) : t, o = e.length - 1, i;
      o >= 0;
      o--
    )
      (i = e[o]) && (s = (r ? i(t, n, s) : i(s)) || s);
...
Tt.styles = [et, z``];
Tt = br([Y("integration-selection")], Tt);
var Er = Object.defineProperty,
  vr = Object.getOwnPropertyDescriptor,
  nt = (e, t, n, r) => {
    for (
      var s = r > 1 ? void 0 : r ? vr(t, n) : t, o = e.length - 1, i;
      o >= 0;
      o--
    )
      (i = e[o]) && (s = (r ? i(t, n, s) : i(s)) || s);
...
nt([_({ type: Number, state: !0 })], U.prototype, "step", 2);
nt([_({ type: Boolean })], U.prototype, "appsDataLoaded", 2);
nt([_()], U.prototype, "appsData", 2);
nt([_({ type: Boolean })], U.prototype, "appsApiError", 2);
U = nt([Y("knit-popup")], U);
var _r = Object.defineProperty,
  wr = Object.getOwnPropertyDescriptor,
  A = (e, t, n, r) => {
    for (
      var s = r > 1 ? void 0 : r ? wr(t, n) : t, o = e.length - 1, i;
      o >= 0;
      o--
    )
      (i = e[o]) && (s = (r ? i(t, n, s) : i(s)) || s);
...
let w = class extends x {
  ...
  _onInitiatorClick(e) {
    e.preventDefault,
      ...
      this.isReady && this._togglePopup();
  }
  _togglePopup(e) {
  ...
  updated(e) {
    e.has("knitKey") &&
      ...
      this.knitKey.length > 0 && !this.isReady && (this.isReady = !0)),
      e.has("popupEnabled") && this.popupEnabled && this._fetchAppsData(),
      e.has("onRefreshKnit") && console.log("knit", this.onRefreshKnit);
  }
  _fetchAppsData() {
...
A([_()], w.prototype, "docsHint", 2);
A([_({ type: Boolean, state: !0 })], w.prototype, "isReady", 2);
A([_({ type: Number, state: !0 })], w.prototype, "count", 2);
A([_({ type: Function })], w.prototype, "onRefreshKnit", 2);
A([_({ type: String })], w.prototype, "knitKey", 2);
A([_({ type: Boolean, state: !0 })], w.prototype, "popupEnabled", 2);
A([_({ type: Boolean, state: !0 })], w.prototype, "appsDataLoaded", 2);
A([_()], w.prototype, "appsData", 2);
A([_({ type: Boolean, state: !0 })], w.prototype, "appsApiError", 2);
w = A([Y("knit-auth")], w);
export { w as KnitAuth };
